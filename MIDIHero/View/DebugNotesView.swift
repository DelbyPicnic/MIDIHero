        ...
        Form {
            Section(header: Text("Debug Options")){
                Button(action: {
                    ...
                    FormRowView(icon: "pianokeys", iconColor: Color.purple, heading: "Note", subtext: "C3")
                }
                Button(action: {
                    midiHero.playNote(note: Note.D3)
                }) {
                    FormRowView(icon: "pianokeys", iconColor: Color.purple, heading: "Note", subtext: "D3")
                }
                Button(action: {
                    midiHero.playNote(note: Note.E3)
                }) {
                    FormRowView(icon: "pianokeys", iconColor: Color.purple, heading: "Note", subtext: "E3")
                }
            }
            .padding(.vertical, 3)
